...
\hline
    \multirow{2}{*}{} & \multicolumn{2}{c|}{Highlight} & \multicolumn{3}{c|}{Diagnostics} & \multicolumn{4}{c|}{Completion}  & \multirow{2}{*}{} & \multirow{2}{*}{} \\ \cline{2-10} 
      LSP implementation                                  & \rotatebox{90}{Syntactic} & \rotatebox{90}{Semantic}
                                        & \rotatebox{90}{Syntax} & \rotatebox{90}{Undefined} & \rotatebox{90}{Validation\ \ } 
                                        & \rotatebox{90}{Syntax} & \rotatebox{90}{Tokens} & \rotatebox{90}{Naieve} & \rotatebox{90}{Typed}
                                        & \rotatebox{90}{Formatting} 
                                        & \rotatebox{90}{Renaming} \\ \hline
