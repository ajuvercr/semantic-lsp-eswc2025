...
Some editors, such as NeoVim\info{Add footnote link}, treat language servers as first-class citizens, offering seamless integration.
Others, like Visual Studio Code and Monaco\info{Add footnote links}, require additional glue code to enable effective interaction.
...
Another editor showcases a simple SPARQL query, which, when executed\info{Is the query executed or the demo? Please clarify}, provides insights derived from data structured according to the ontology.
...
Additionally, the language server supports quality assurance by helping power users to identify common pitfalls such as punning\unsure{Is punning a pitfall? If you have a reference please add it, otherwise this is a dangerous claim} or poorly structured ontologies, ensuring their semantic documents are both accurate and high quality.
