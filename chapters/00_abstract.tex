...
\begin{abstract}
% Context (What is needed to understand the "need"?)
RDF has introduced a variety of syntaxes for e.g., serializing, querying, and validating linked data, such as Turtle, SPARQL, and SHACL.
% Need (Why something needed to be done at all?)
...
% Object (What the present document does or covers)
To that extent, we introduce the Semantic Language Server (SLS), a language server with features such as real-time syntax validation, autocompletion, and SHACL-based diagnostics to notify users of potential mistakes early in the development process.
