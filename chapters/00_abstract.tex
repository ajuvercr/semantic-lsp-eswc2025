...
% Findings (What the work done yielded or revealed)
By building on and extending the state of the art, our tool aims on improving the development efficiency, precision, and confidence of various user groups, including semantic power users, newcomers, domain experts, and data engineers.
% Conclusion (What the findings mean for the audience)
