...
\item \textbf{Domain Experts}\\
   Domain experts frequently engage with Semantic Web technologies to evaluate and refine domain-specific data models, often utilizing tools such as Protégé.
    SWLS complements this workflow by enabling experts to efficiently create small datasets and interactively explore their ontology, allowing them to assess whether property descriptions and relationships are coherent.
...
This approach is especially beneficial for quick iterations.
